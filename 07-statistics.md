...
>> The probability that Elvis was an identical twin is 5/11, or ~45.5%. 
```
P(identical | male twin) = (P(male | identical) * P(identical)) / P(male twin)
                         = (P(male | identical) * P(identical)) / (P(male twin | identical) * P(identical)) + 
                                                                  (P(male twin | fraternal) * P(fraternal))
